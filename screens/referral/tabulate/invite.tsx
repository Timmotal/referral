...
<Text style={styles.codeText}>Your unique referral code</Text>
<View style={styles.codeContainer}>
  <Text style={styles.referralCode}>billpoint-MORTAL11d</Text>

  {/* <TouchableOpacity style={styles.copyButton}>
    <Image source={{ uri : image}} style={styles.copyIcon} />
  </TouchableOpacity> */}

  <View style={styles.copyButtonContainer}>
  <FontAwesome5 name="copy" size={18} color="#4fa66a" />
  <TouchableOpacity>
   ...
   Copy your code
     ...
     {/* <Button 
        ...
        onPress={() => {console.warn("Handle copy functionality")}} 
        style={styles.copyButtonClick} 
